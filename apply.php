...
<form method="post" action="process_eoi.php" novalidate="novalidate">
  <div class="form-container-job-apply">
    ...
    <div class="form-label">
      ...
      <input type="text" id="street" name="street" maxlength="40" placeholder="max 40 characters" required>
    </div>
    ...
    <div class="form-label">
      <div class="skill-tickbox-container">
        ...
        <div class="checkbox-group">
          ...
          <div>
            <input type="checkbox" id="otherskills_checkbox" name="otherskills_checkbox" value="otherskills_checked">
    ...
    <div class="form-label">
      <div class="form-row">
        ...
        <textarea id="otherskills_input" name="otherskills_input" rows="4" cols="40"> </textarea>
      </div>
    </div>
